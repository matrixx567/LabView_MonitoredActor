...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Test" Type="Folder">
			<Item Name="Test Support" Type="Folder">
				<Item Name="Test Actor.lvclass" Type="LVClass" URL="../Test/Test Actor/Test Actor.lvclass"/>
			</Item>
			<Item Name="Monitor Test.lvclass" Type="LVClass" URL="../Test/Monitor Test/Monitor Test.lvclass"/>
		</Item>
		<Item Name="MGI-Monitored Actor.lvlib" Type="Library" URL="../Source/MGI-Monitored Actor.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Actor Data.ctl" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Monitor Data/Actor Data.ctl"/>
			<Item Name="Actor Monitor.lvclass" Type="LVClass" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Actor Monitor/Actor Monitor/Actor Monitor.lvclass"/>
			<Item Name="AF Debug.lvlib" Type="Library" URL="/&lt;resource&gt;/AFDebug/AF Debug.lvlib"/>
			<Item Name="Get Actor Data.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Monitor Data/Get Actor Data.vi"/>
			<Item Name="LV Config Read String.vi" Type="VI" URL="/&lt;resource&gt;/dialog/lvconfig.llb/LV Config Read String.vi"/>
			<Item Name="Monitor Data.lvclass" Type="LVClass" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Monitor Data/Monitor Data.lvclass"/>
			<Item Name="Monitored Actor.lvclass" Type="LVClass" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Monitored Actor/Monitored Actor/Monitored Actor.lvclass"/>
			<Item Name="Open Actor Core.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Monitor Data/Open Actor Core.vi"/>
			<Item Name="Ping Actor Msg.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Actor Monitor/Actor Monitor Messages/Ping Actor Msg/Ping Actor Msg.vi"/>
			<Item Name="Read Monitor Data.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Actor Monitor/Actor Monitor/Read Monitor Data.vi"/>
			<Item Name="Send Disable Message Logging.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Monitored Actor/Monitored Actor Messages/Disable Message Logging Msg/Send Disable Message Logging.vi"/>
			<Item Name="Send Enable Message Logging.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Monitored Actor/Monitored Actor Messages/Enable Message Logging Msg/Send Enable Message Logging.vi"/>
			<Item Name="Send Manually Remove Actor.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Actor Monitor/Actor Monitor Messages/Manually Remove Actor Msg/Send Manually Remove Actor.vi"/>
			<Item Name="Send Ping Actor.vi" Type="VI" URL="../gpm_packages/@mgi/monitored-actor-core/Source/Actor Monitor/Actor Monitor Messages/Ping Actor Msg/Send Ping Actor.vi"/>
